...
import '/ui/one2_screen/bloc/one2_bloc.dart';
...
class One2Screen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<One2Bloc>(
      create: (context) => One2Bloc(One2State(
        one2ModelObj: One2Model(),
      ))
        ..add(One2InitialEvent()),
      child: One2Screen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<One2Bloc, One2State>(
