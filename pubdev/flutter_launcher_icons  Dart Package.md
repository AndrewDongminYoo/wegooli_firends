...
## Android [#](https://pub.dev/packages/flutter_launcher_icons#android)
...
- `adaptive_icon_foreground`: The image asset which will be used for the icon foreground of the adaptive icon _Note: Adaptive Icons will only be generated when both adaptive_icon_background and adaptive_icon_foreground are specified. (the image_path is not automatically taken as foreground)_
...
For best results try and use a foreground image which has padding much like [the one in the example](https://github.com/fluttercommunity/flutter_launcher_icons/blob/main/example/default_example/assets/images/icon-foreground-432x432.png).
