...
import '/ui/smart_key_screen_page/bloc/smart_key_screen_bloc.dart';
import '/ui/smart_key_screen_page/models/smart_key_screen_model.dart';
...
class SmartKeyScreenPage extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SmartKeyScreenBloc>(
      create: (context) => SmartKeyScreenBloc(SmartKeyScreenState(
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<SmartKeyScreenBloc, SmartKeyScreenState>(
