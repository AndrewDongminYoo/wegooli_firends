import 'package:wegooli_friends_app/presentation/unsubscribe_confirm_dialog/bloc/unsubscribe_confirm_bloc.dart';import 'package:wegooli_friends_app/presentation/unsubscribe_confirm_dialog/models/unsubscribe_confirm_model.dart';import 'package:flutter/material.dart';import 'package:wegooli_friends_app/core/app_export.dart';import 'package:wegooli_friends_app/widgets/custom_elevated_button.dart';class UnsubscribeConfirmDialog extends StatelessWidget {const UnsubscribeConfirmDialog({Key? key}) : super(key: key);

static Widget builder(BuildContext context) { return BlocProvider<UnsubscribeConfirmBloc>(create: (context) => UnsubscribeConfirmBloc(UnsubscribeConfirmState(unsubscribeConfirmModelObj: UnsubscribeConfirmModel()))..add(UnsubscribeConfirmInitialEvent()), child: const UnsubscribeConfirmDialog()); }
