...
part of 'terminal_model_by_team.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TerminalModelByTeam _$TerminalModelByTeamFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      'TerminalModelByTeam',
      json,
      ($checkedConvert) {
        final val = TerminalModelByTeam(
...
Map<String, dynamic> _$TerminalModelByTeamToJson(TerminalModelByTeam instance) {
