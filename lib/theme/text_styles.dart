...
class CustomTextStyles {
  ...
  static get titleSmallRedA700 =>
      theme.textTheme.titleSmall!.copyWith(color: appTheme.redA700);
  static get titleMediumBlack900_1 =>
  ...
  static get bodySmallInterGray400_1 =>
      theme.textTheme.bodySmall!.inter.copyWith(color: appTheme.gray400);
  ...
  static get bodySmallInterSecondaryContainer_1 =>
      theme.textTheme.bodySmall!.inter
  ...
  static get bodyMediumInterOnPrimaryContainer =>
      theme.textTheme.bodyMedium!.inter
          .copyWith(color: theme.colorScheme.onPrimaryContainer);
  static get bodyMediumInterGray600 =>
      theme.textTheme.bodyMedium!.inter.copyWith(color: appTheme.gray600);
  static get bodySmallSecondaryContainer => theme.textTheme.bodySmall!
      .copyWith(color: theme.colorScheme.secondaryContainer);
}
