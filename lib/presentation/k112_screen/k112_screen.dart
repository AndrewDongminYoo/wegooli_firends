import 'package:wegooli_friends_app/presentation/k112_screen/bloc/k112_bloc.dart';import 'package:wegooli_friends_app/presentation/k112_screen/models/k112_model.dart';import 'package:flutter/material.dart';import 'package:wegooli_friends_app/core/app_export.dart';import 'package:wegooli_friends_app/widgets/app_bar/appbar_image_1.dart';import 'package:wegooli_friends_app/widgets/app_bar/appbar_subtitle_1.dart';import 'package:wegooli_friends_app/widgets/app_bar/custom_app_bar.dart';class K112Screen extends StatelessWidget {const K112Screen({Key? key}) : super(key: key);

static Widget builder(BuildContext context) { return BlocProvider<K112Bloc>(create: (context) => K112Bloc(K112State(k112ModelObj: K112Model()))..add(K112InitialEvent()), child: const K112Screen()); }
