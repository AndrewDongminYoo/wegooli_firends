import 'package:wegooli_friends_app/presentation/unsubscribe_screen/bloc/unsubscribe_bloc.dart';import 'package:wegooli_friends_app/presentation/unsubscribe_screen/models/unsubscribe_model.dart';import 'package:flutter/material.dart';import 'package:wegooli_friends_app/core/app_export.dart';import 'package:wegooli_friends_app/widgets/app_bar/appbar_image_1.dart';import 'package:wegooli_friends_app/widgets/app_bar/appbar_title.dart';import 'package:wegooli_friends_app/widgets/app_bar/custom_app_bar.dart';import 'package:wegooli_friends_app/widgets/custom_elevated_button.dart';class UnsubscribeScreen extends StatelessWidget {const UnsubscribeScreen({Key? key}) : super(key: key);

static Widget builder(BuildContext context) { return BlocProvider<UnsubscribeBloc>(create: (context) => UnsubscribeBloc(UnsubscribeState(unsubscribeModelObj: UnsubscribeModel()))..add(UnsubscribeInitialEvent()), child: const UnsubscribeScreen()); }
