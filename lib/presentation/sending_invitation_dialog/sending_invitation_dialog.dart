import 'controller/sending_invitation_controller.dart';
...
class SendingInvitationDialog extends StatelessWidget {
  SendingInvitationDialog(this.controller, {Key? key}) : super(key: key);

  SendingInvitationController controller;
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
        child: Container(
            margin: getMargin(left: 16, right: 16, bottom: 318),
