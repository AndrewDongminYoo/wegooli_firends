...
class CustomTextStyles {
  ...
  static TextStyle get titleMediumBlack900 => theme.textTheme.titleMedium!
      .copyWith(color: appTheme.black900, fontSize: getFontSize(18));
  ...
  static TextStyle get titleMediumBluegray900 => theme.textTheme.titleMedium!
      .copyWith(color: appTheme.blueGray900, fontSize: getFontSize(18));
  ...
  static TextStyle get bodySmallInterOnError10 => theme
      .textTheme.bodySmall!.inter
      .copyWith(color: theme.colorScheme.onError, fontSize: getFontSize(10));
  static TextStyle get bodySmallInterOnPrimary => theme
      .textTheme.bodySmall!.inter
      .copyWith(color: theme.colorScheme.onPrimary, fontSize: getFontSize(10));
  ...
  static TextStyle get bodySmallPretendardBlack900 =>
      theme.textTheme.bodySmall!.pretendard
          .copyWith(color: appTheme.black900, fontSize: getFontSize(12));
  ...
  static TextStyle get bodySmallPretendardErrorContainer =>
      theme.textTheme.bodySmall!.pretendard.copyWith(
          color: theme.colorScheme.errorContainer, fontSize: getFontSize(12));
  static TextStyle get bodySmallPretendardGray50003 =>
      theme.textTheme.bodySmall!.pretendard.copyWith(color: appTheme.gray50003);
  static TextStyle get bodySmallPretendardGray700 =>
      theme.textTheme.bodySmall!.pretendard
          .copyWith(color: appTheme.gray700, fontSize: getFontSize(12));
  static TextStyle get bodySmallPretendardOnPrimary => theme
      .textTheme.bodySmall!.pretendard
      .copyWith(color: theme.colorScheme.onPrimary, fontSize: getFontSize(12));
