...
import '/ui/k93_screen/bloc/k93_bloc.dart';
...
class K93Screen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<K93Bloc>(
      create: (context) => K93Bloc(K93State(
        k93ModelObj: K93Model(),
      ))
        ..add(K93InitialEvent()),
      child: K93Screen(),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<K93Bloc, K93State>(
