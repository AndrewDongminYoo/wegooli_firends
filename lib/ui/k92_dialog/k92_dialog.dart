...
import '/ui/k92_dialog/bloc/k92_bloc.dart';
...
class K92Dialog extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<K92Bloc>(
        create: (context) =>
            K92Bloc(K92State(k92ModelObj: K92Model()))..add(K92InitialEvent()),
        child: const K92Dialog());
  }
