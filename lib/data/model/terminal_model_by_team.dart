...
part 'terminal_model_by_team.g.dart';
...
class TerminalModelByTeam extends Equatable {
  /// Returns a new [TerminalModelByTeam] instance.
  const TerminalModelByTeam({
    this.seq,
    this.delYn,
    this.createdAt,
    this.updatedAt,
  ...
  factory TerminalModelByTeam.fromJson(Map<String, dynamic> json) =>
      _$TerminalModelByTeamFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$TerminalModelByTeamToJson(this);
