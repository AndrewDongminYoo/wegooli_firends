...
/// This class defines the variables used in the [k72_screen],
/// and is typically used to hold data that is passed between different parts of the application.
class K72Model extends Equatable {
  K72Model({
    this.userprofile1ItemList = const [],
    this.datecolumnItemList = const [],
  });
  ...
  @override
  List<Object?> get props => [userprofile1ItemList, datecolumnItemList];
}
