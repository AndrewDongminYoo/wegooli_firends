...
class ViewScheduledDateSchedulerOnlyModel extends Equatable {
  ViewScheduledDateSchedulerOnlyModel({this.listviewItemList = const []});

  List<ListviewItemModel> listviewItemList;

  ViewScheduledDateSchedulerOnlyModel copyWith(
      {List<ListviewItemModel>? listviewItemList}) {
    return ViewScheduledDateSchedulerOnlyModel(
