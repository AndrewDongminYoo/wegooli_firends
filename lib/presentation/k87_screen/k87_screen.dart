import 'package:wegooli_friends_app/presentation/k87_screen/bloc/k87_bloc.dart';import 'package:wegooli_friends_app/presentation/k87_screen/models/k87_model.dart';import 'package:flutter/material.dart';import 'package:wegooli_friends_app/core/app_export.dart';import 'package:wegooli_friends_app/widgets/app_bar/appbar_image_1.dart';import 'package:wegooli_friends_app/widgets/app_bar/appbar_title.dart';import 'package:wegooli_friends_app/widgets/app_bar/custom_app_bar.dart';class K87Screen extends StatelessWidget {const K87Screen({Key? key}) : super(key: key);

static Widget builder(BuildContext context) { return BlocProvider<K87Bloc>(create: (context) => K87Bloc(K87State(k87ModelObj: K87Model()))..add(K87InitialEvent()), child: const K87Screen()); }
