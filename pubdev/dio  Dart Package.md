...
Language: English | [简体中文](https://github.com/cfug/dio/blob/main/dio/README-ZH.md)
...
- [dio](https://pub.dev/packages/dio#dio)
  - [Get started](https://pub.dev/packages/dio#get-started)
    - [Add dependency](https://pub.dev/packages/dio#add-dependency)
    - [Super simple to use](https://pub.dev/packages/dio#super-simple-to-use)
  - [Awesome dio](https://pub.dev/packages/dio#awesome-dio)
    - [Plugins](https://pub.dev/packages/dio#plugins)
    - [Related Projects](https://pub.dev/packages/dio#related-projects)
  - [Examples](https://pub.dev/packages/dio#examples)
  - [Dio APIs](https://pub.dev/packages/dio#dio-apis)
    - [Creating an instance and set default configs.](https://pub.dev/packages/dio#creating-an-instance-and-set-default-configs)
    - [Request Options](https://pub.dev/packages/dio#request-options)
    - [Response](https://pub.dev/packages/dio#response)
    - [Interceptors](https://pub.dev/packages/dio#interceptors)
      - [Resolve and reject the request](https://pub.dev/packages/dio#resolve-and-reject-the-request)
      - [QueuedInterceptor](https://pub.dev/packages/dio#queuedinterceptor)
        - [Example](https://pub.dev/packages/dio#example)
      - [LogInterceptor](https://pub.dev/packages/dio#loginterceptor)
      - [Custom Interceptor](https://pub.dev/packages/dio#custom-interceptor)
  - [Handling Errors](https://pub.dev/packages/dio#handling-errors)
    - [DioException](https://pub.dev/packages/dio#dioexception)
    - [DioExceptionType](https://pub.dev/packages/dio#dioexceptiontype)
  - [Using application/x-www-form-urlencoded format](https://pub.dev/packages/dio#using-applicationx-www-form-urlencoded-format)
  - [Sending FormData](https://pub.dev/packages/dio#sending-formdata)
    - [Multiple files upload](https://pub.dev/packages/dio#multiple-files-upload)
    - [Reuse `FormData`s and `MultipartFile`s](https://pub.dev/packages/dio#reuse-formdatas-and-multipartfiles)
  - [Transformer](https://pub.dev/packages/dio#transformer)
    - [In Flutter](https://pub.dev/packages/dio#in-flutter)
    - [Other example](https://pub.dev/packages/dio#other-example)
  - [HttpClientAdapter](https://pub.dev/packages/dio#httpclientadapter)
    - [Using proxy](https://pub.dev/packages/dio#using-proxy)
    - [HTTPS certificate verification](https://pub.dev/packages/dio#https-certificate-verification)
  - [HTTP/2 support](https://pub.dev/packages/dio#http2-support)
  - [Cancellation](https://pub.dev/packages/dio#cancellation)
  - [Extends Dio class](https://pub.dev/packages/dio#extends-dio-class)
  - [Cross-Origin Resource Sharing on Web (CORS)](https://pub.dev/packages/dio#cross-origin-resource-sharing-on-web-cors)
...
The latest version is: ![Pub](https://img.shields.io/pub/v/dio.svg) The latest version including pre-releases is: ![Pub](https://img.shields.io/pub/v/dio?include_prereleases)

**Before you upgrade: Breaking changes might happen in major and minor versions of packages.
See the [Migration Guide](https://github.com/cfug/dio/blob/main/dio/migration_guide.md) for the complete breaking changes list.**
...
Welcome to submit third-party plugins and related libraries in [here](https://github.com/cfug/dio/issues/347).
...
See all examples code [here](https://github.com/cfug/dio/blob/main/dio/example).

## Creating an instance and set default configs. [#](https://pub.dev/packages/dio#creating-an-instance-and-set-default-configs)

> It is recommended to use a singleton of `Dio` in projects, which can manage configurations like headers, base urls, and timeouts consistently. Here is an [example](https://github.com/cfug/dio/blob/main/example_flutter_app) that use a singleton in Flutter.
...
There is a complete example [here](https://github.com/cfug/dio/blob/main/example/lib/options.dart).
...
For the complete code see [here](https://github.com/cfug/dio/blob/main/example/lib/queued_interceptor_crsftoken.dart).
...
You can customize interceptor by extending the `Interceptor/QueuedInterceptor` class. There is an example that implementing a simple cache policy: [custom cache interceptor](https://github.com/cfug/dio/blob/main/example/lib/custom_cache_interceptor.dart).
...
See [the source code](https://github.com/cfug/dio/blob/main/dio/lib/src/dio_exception.dart).
...
There is a complete example [here](https://github.com/cfug/dio/blob/main/example/lib/formdata.dart).
...
There is an example for [customizing Transformer](https://github.com/cfug/dio/blob/main/example/lib/transformer.dart).
...
[Here](https://github.com/cfug/dio/blob/main/example/lib/adapter.dart) is a simple example to custom adapter.
...
There is a complete example [here](https://github.com/cfug/dio/blob/main/example/lib/proxy.dart).
...
[dio_http2_adapter](https://github.com/cfug/dio/blob/main/plugins/http2_adapter) is a Dio `HttpClientAdapter` which supports HTTP/2.
...
There is a complete example [here](https://github.com/cfug/dio/blob/main/example/lib/cancel_request.dart).
...
If a request is not a [simple request](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS#simple_requests), the Web browser will send a [CORS preflight request](https://developer.mozilla.org/en-US/docs/Glossary/Preflight_request) that checks to see if the CORS protocol is understood and a server is aware using specific methods and headers.
