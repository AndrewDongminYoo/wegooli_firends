...
class SmartKeyNotAvailable extends GetWidget<VehicleController> {
  @override
                ...
                child: Column(
                    ...
                    children: [
                      Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                CustomImageView(
                                    imagePath:
                                        Assets.images.imgCarMorUrban.path,
                                    height: getVerticalSize(92),
                                    width: getHorizontalSize(139)),
                                Padding(
                                    padding: getPadding(top: 8, bottom: 18),
                                    child: Column(
                                        crossAxisAlignment:
                          ...
                          child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                    ...
                                    child: Text(
                                      l10ns.hongGilDongIsUsingIt(l10ns.name1),
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.left,
                                      style:
                      ...
                      Container(
                          ...
                          child: Stack(alignment: Alignment.center, children: [
                            ...
                            Align(
                              ...
                              child: Container(
                                padding: getPadding(
                                    left: 85, top: 128, right: 85, bottom: 128),
                      ...
                      FloatingActionButton.extended(
                          onPressed: () {},
                          label: Text(l10ns.reportAnIncident),
                          elevation: 6.0,
                          extendedPadding: getMargin(all: getVerticalSize(52)),
                          ...
                          extendedTextStyle: CustomTextStyles.titleMedium18),
                    ]),
              ),
            )),
