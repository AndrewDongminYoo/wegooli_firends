                              ...
                              Padding(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        CustomImageView(
                                            imagePath: Assets
                                                .images.imgCarMorUrban.path,
                                            height: getVerticalSize(92),
                                            width: getHorizontalSize(139)),
                                        Padding(
                                            padding:
                                                getPadding(top: 8, bottom: 18),
                                            child: Column(
                                                crossAxisAlignment:
                                                    CrossAxisAlignment.start,
                                                mainAxisAlignment:
                                                                    ...
                                                                    children: [
                                                                      Align(
                                                                          ...
                                                                          child: Container(
                                                                              ...
                                                                              child: Container(height: getSize(120), width: getSize(120), decoration: BoxDecoration(color: theme.colorScheme.onPrimaryContainer, borderRadius: BorderRadius.circular(getHorizontalSize(60)), border: Border.all(color: appTheme.blueGray30033, width: getHorizontalSize(1)))))),
                                                                      Align(
                                                                          alignment:
                                                                              Alignment.center,
                                                                          child: Padding(
                                                          ...
                                                          child: Row(
                                                              ...
                                                              children: [
                                                                Container(
                                                                    ...
                                                                    child: Container(
                                                                        padding: getPadding(left: 37, top: 24, right: 37, bottom: 24),
                                                                        decoration: AppDecoration.outlineBlueGray.copyWith(borderRadius: BorderRadiusStyle.circleBorder60),
                                                                        child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                          CustomImageView(
