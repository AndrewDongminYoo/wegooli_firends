...
[![Buy Me A Coffee](https://i.imgur.com/aV6DDA7.png)](https://www.buymeacoffee.com/jonataslaw)
![getx](https://raw.githubusercontent.com/jonataslaw/getx-community/master/getx.png)

- [About Get](https://pub.dev/packages/get#about-get)
- [Installing](https://pub.dev/packages/get#installing)
- [Counter App with GetX](https://pub.dev/packages/get#counter-app-with-getx)
- [The Three pillars](https://pub.dev/packages/get#the-three-pillars)
  - [State management](https://pub.dev/packages/get#state-management)
    - [Reactive State Manager](https://pub.dev/packages/get#reactive-state-manager)
    - [More details about state management](https://pub.dev/packages/get#more-details-about-state-management)
  - [Route management](https://pub.dev/packages/get#route-management)
    - [More details about route management](https://pub.dev/packages/get#more-details-about-route-management)
  - [Dependency management](https://pub.dev/packages/get#dependency-management)
    - [More details about dependency management](https://pub.dev/packages/get#more-details-about-dependency-management)
- [Utils](https://pub.dev/packages/get#utils)
  - [Internationalization](https://pub.dev/packages/get#internationalization)
    - [Translations](https://pub.dev/packages/get#translations)
      - [Using translations](https://pub.dev/packages/get#using-translations)
    - [Locales](https://pub.dev/packages/get#locales)
      - [Change locale](https://pub.dev/packages/get#change-locale)
      - [System locale](https://pub.dev/packages/get#system-locale)
  - [Change Theme](https://pub.dev/packages/get#change-theme)
  - [GetConnect](https://pub.dev/packages/get#getconnect)
    - [Default configuration](https://pub.dev/packages/get#default-configuration)
    - [Custom configuration](https://pub.dev/packages/get#custom-configuration)
  - [GetPage Middleware](https://pub.dev/packages/get#getpage-middleware)
    - [Priority](https://pub.dev/packages/get#priority)
    - [Redirect](https://pub.dev/packages/get#redirect)
    - [onPageCalled](https://pub.dev/packages/get#onpagecalled)
    - [OnBindingsStart](https://pub.dev/packages/get#onbindingsstart)
    - [OnPageBuildStart](https://pub.dev/packages/get#onpagebuildstart)
    - [OnPageBuilt](https://pub.dev/packages/get#onpagebuilt)
    - [OnPageDispose](https://pub.dev/packages/get#onpagedispose)
  - [Other Advanced APIs](https://pub.dev/packages/get#other-advanced-apis)
    - [Optional Global Settings and Manual configurations](https://pub.dev/packages/get#optional-global-settings-and-manual-configurations)
    - [Local State Widgets](https://pub.dev/packages/get#local-state-widgets)
      - [ValueBuilder](https://pub.dev/packages/get#valuebuilder)
      - [ObxValue](https://pub.dev/packages/get#obxvalue)
  - [Useful tips](https://pub.dev/packages/get#useful-tips)
    - [GetView](https://pub.dev/packages/get#getview)
    - [GetResponsiveView](https://pub.dev/packages/get#getresponsiveview)
      - [How to use it](https://pub.dev/packages/get#how-to-use-it)
    - [GetWidget](https://pub.dev/packages/get#getwidget)
    - [GetxService](https://pub.dev/packages/get#getxservice)
- [Breaking changes from 2.0](https://pub.dev/packages/get#breaking-changes-from-20)
- [Why Getx?](https://pub.dev/packages/get#why-getx)
- [Community](https://pub.dev/packages/get#community)

  - [Community channels](https://pub.dev/packages/get#community-channels)
  - [How to contribute](https://pub.dev/packages/get#how-to-contribute)
  - [Articles and videos](https://pub.dev/packages/get#articles-and-videos)
...
![getx](https://raw.githubusercontent.com/jonataslaw/getx-community/master/counter-app-gif.gif)
...
**See a more in-depth explanation of dependency management [here](https://github.com/jonataslaw/getx/blob/main/documentation/en_US/dependency_management.md)**
...
Similar to [`ValueBuilder`](https://pub.dev/packages/get#valuebuilder), but this is the Reactive version, you pass a Rx instance (remember the magical .obs?) and updates automatically... isn't it awesome?
...
![example](https://github.com/SchabanBo/get_page_example/blob/main/docs/Example.gif?raw=true) Code to this screen [code](https://github.com/SchabanBo/get_page_example/blob/main/lib/pages/responsive_example/responsive_view.dart)
