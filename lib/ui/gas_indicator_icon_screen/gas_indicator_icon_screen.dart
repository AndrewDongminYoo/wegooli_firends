...
import '/ui/gas_indicator_icon_screen/bloc/gas_indicator_icon_bloc.dart';
import '/ui/gas_indicator_icon_screen/models/gas_indicator_icon_model.dart';
...
class GasIndicatorIconScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<GasIndicatorIconBloc>(
      create: (context) => GasIndicatorIconBloc(GasIndicatorIconState(
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<GasIndicatorIconBloc, GasIndicatorIconState>(
