...
class TeamAccountConnectionControllerApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<TeamAccountConnectionModel>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<TeamAccountConnectionModel>>>
    ...
    BuiltList<TeamAccountConnectionModel>? _responseData;
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              ...
              specifiedType: const FullType(
                  BuiltList, [FullType(TeamAccountConnectionModel)]),
            ) as BuiltList<TeamAccountConnectionModel>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<TeamAccountConnectionModel>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
