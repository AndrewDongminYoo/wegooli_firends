...
class CarManagementModel {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CarManagementModel &&
     other.seq == seq &&
     other.carNum == carNum &&
  ...
  factory CarManagementModel.fromJson(Map<String, dynamic> json) => _$CarManagementModelFromJson(json);
