...
class SmartKeyTab extends StatefulWidget {
  ...
  static const androidIcon = Icon(Icons.car_rental, size: 28.0);
  static const iosIcon = Icon(CupertinoIcons.car_detailed, size: 28.0);

  const SmartKeyTab({super.key});

  @override
  State<SmartKeyTab> createState() => _SmartKeyTabState();
}

class _SmartKeyTabState extends State<SmartKeyTab> {
