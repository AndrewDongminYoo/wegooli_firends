import 'package:wegooli_friends_app/presentation/mypage_contact_us_empty_history_screen/bloc/mypage_contact_us_empty_history_bloc.dart';import 'package:wegooli_friends_app/presentation/mypage_contact_us_empty_history_screen/models/mypage_contact_us_empty_history_model.dart';import 'package:flutter/material.dart';import 'package:wegooli_friends_app/core/app_export.dart';import 'package:wegooli_friends_app/widgets/app_bar/appbar_image_1.dart';import 'package:wegooli_friends_app/widgets/app_bar/appbar_title.dart';import 'package:wegooli_friends_app/widgets/app_bar/custom_app_bar.dart';import 'package:wegooli_friends_app/widgets/custom_elevated_button.dart';class MyPageContactUsEmptyHistoryScreen extends StatelessWidget {const MyPageContactUsEmptyHistoryScreen({Key? key}) : super(key: key);

static Widget builder(BuildContext context) { return BlocProvider<MyPageContactUsEmptyHistoryBloc>(create: (context) => MyPageContactUsEmptyHistoryBloc(MyPageContactUsEmptyHistoryState(mypageContactUsEmptyHistoryModelObj: MyPageContactUsEmptyHistoryModel()))..add(MyPageContactUsEmptyHistoryInitialEvent()), child: const MyPageContactUsEmptyHistoryScreen()); }
