...
class UpcomingUnsubscriptionScreen
    extends GetWidget<UpcomingUnsubscriptionController> {
  const UpcomingUnsubscriptionScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(
                    ...
                    children: [
                      CustomImageView(
                          svgPath: ImageConstant.imgCarBlack90016x65,
