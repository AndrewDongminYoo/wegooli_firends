...
tags: []
source: https://pub.dev/packages/import_sorter
author:
---
...
## 💻 Command Line [#](https://pub.dev/packages/import_sorter#-command-line)
...
If you need another example check the [example app's import_sorter configuration](https://github.com/fluttercommunity/import_sorter/blob/main/example/example_app/pubspec.yaml#L76).
...
[import_sorter | Dart Package](https://pub.dev/packages/import_sorter)
