...
class _$UserDetailsDTOSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.userDto != null) {
      yield r'userDto';
      yield serializers.serialize(object.userDto,
          specifiedType: const FullType(UserDTO));
    }
    if (object.authorities != null) {
      yield r'authorities';
      yield serializers.serialize(object.authorities,
          specifiedType:
    ...
    if (object.enabled != null) {
      yield r'enabled';
      yield serializers.serialize(object.enabled,
    ...
    if (object.accountNonExpired != null) {
      ...
      yield serializers.serialize(object.accountNonExpired,
          specifiedType: const FullType(bool));
    }
    if (object.accountNonLocked != null) {
      yield r'accountNonLocked';
      yield serializers.serialize(object.accountNonLocked,
          specifiedType: const FullType(bool));
    }
    if (object.credentialsNonExpired != null) {
      yield r'credentialsNonExpired';
      yield serializers.serialize(object.credentialsNonExpired,
          specifiedType: const FullType(bool));
    }
