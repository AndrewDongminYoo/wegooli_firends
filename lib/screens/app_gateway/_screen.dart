...
class GatewayScreen extends GetWidget<AppGatewayController> {
  ...
  Widget build(BuildContext context) {
    ...
    var toRegisterZipCode = GestureDetector(
        onTap: () {
            ...
            child:
              ...
              Align(
                  ...
                  child: Padding(
                      ...
                      child: Text("msg_login_register_zip_code".tr,
    ...
    var toTapSignUpAcceptTerms = GestureDetector(
        onTap: () {
            ...
            child:
              ...
              Align(
                  ...
                  child: Padding(
                      padding:
                          getPadding(left: 20, top: 10, right: 20, bottom: 10),
                      child: Text("msg_signup_accept_terms".tr,
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              color: appTheme.black900,
    ...
    var toTapNoSubscription = GestureDetector(
        onTap: () {
          onTapNoSubscription();
        },
        child: Container(
            ...
            child:
              ...
              Align(
                  ...
                  child: Padding(
                      padding:
                          getPadding(left: 20, top: 10, right: 20, bottom: 10),
                      child: Text("msg_subscription_info_no_service".tr,
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              color: appTheme.black900,
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_login_with_id_and_password"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_login_register_license_page"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_login_register_credit_card"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_login_register_success_page"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_registered_credit_card_list"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_reservations_checking_page"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapReservationDatetimePicker();
                                            },
                                            child: Container(
                                                decoration: AppDecoration.fill6,
                                                child: Column(
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_reservation_datetime_picker"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_unsubscription_confirm_warn"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_upcoming_unsubscription_info"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_upcoming_unsubscription_view"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
  ...
  /// Displays a dialog with the [SendingCrewInvitationDialog] content.
  ///
  /// The [SendingCrewInvitationDialog] widget is created with a new
  /// instance of the [SendingCrewInvitationController],
  ...
  /// Displays a dialog with the [ReservationsCheckingPageDialog] content.
  ///
  /// The [ReservationsCheckingPageDialog] widget is created with a new
  /// instance of the [ReservationsCheckingPageController],
  /// which is obtained using the Get.put() method.
  onTapReservationsCheck() {
    Get.dialog(AlertDialog(
      backgroundColor: Colors.transparent,
  ...
  /// and the [ReservationDatetimePickerBottomSheet] widget.
  ///
  /// The bottom sheet is controlled by the [ReservationDatetimePickerController]
  /// and is displayed using the [Get.bottomSheet] method with
  /// [isScrollControlled] set to true.

  onTapReservationDatetimePicker() {
    Get.bottomSheet(
      ReservationDatetimePickerBottomSheet(
        Get.put(
  ...
  /// Displays a dialog with the [UnsubscriptionConfirmWarnDialog] content.
  ///
  /// The [UnsubscriptionConfirmWarnDialog] widget is created with a new
  /// instance of the [UnsubscriptionConfirmWarnController],
  /// which is obtained using the Get.put() method.
  onTapUnsubscriptionWarn() {
    Get.dialog(AlertDialog(
      backgroundColor: Colors.transparent,
