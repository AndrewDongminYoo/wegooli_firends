...
tags: []
source: https://pub.dev/packages/rive
author:
---
...
## Table of contents [#](https://pub.dev/packages/rive#table-of-contents)

- ⭐ [Rive Overview](https://pub.dev/packages/rive#rive-overview)
- 🚀 [Getting Started & API docs](https://pub.dev/packages/rive#getting-started)
- 🔍 [Supported Platforms](https://pub.dev/packages/rive#supported-platforms)
- 📚 [Examples](https://pub.dev/packages/rive#examples)
- 👨💻 [Contributing](https://pub.dev/packages/rive#contributing)
- ❓ [Issues](https://pub.dev/packages/rive#issues)
...
Be sure to read the [platform specific considerations](https://github.com/rive-app/rive-flutter/blob/main/platform_considerations.md) for the Rive Flutter package.
