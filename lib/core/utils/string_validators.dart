...
bool isValidPassword(String? inputString, {bool isRequired = false}) {
  ...
  if (inputString.isNotNullNorEmpty) {
    isValid = inputString
        .matchPattern(r'^(?=.*?[a-zA-Z])(?=.*?[0-9])(?=.*?[!@#\$&*~]).{6,12}$');
  }
  return isValid;
}
...
bool isValidEmail(String? inputString, {bool isRequired = false}) {
  ...
  if (inputString.isNotNullNorEmpty) {
    isValid = inputString.matchPattern(
...
bool isText(String? inputString, {bool isRequired = false}) {
  ...
  if (inputString != null) {
    isValid = inputString.matchPattern(r'^[a-zA-Z]+$');
  }
  return isValid;
}
...
bool isNumeric(
  ...
  if (inputString.isNotNullNorEmpty) {
    isValid = inputString.matchPattern(r'^\d+$');
  }
  return isValid;
}
...
bool isValidPhone(String? inputString, {bool isRequired = false}) {
  ...
  if (inputString != null) {
    ...
    isValid = inputString
        .matchPattern(r'^01([0|1|6|7|8|9]?)-?([0-9]{3,4})-?([0-9]{4})$');
  }
  return isValid;
}
...
String? isOlderThan25Years(String? birth) {
  ...
  } else if (!birth.matchPattern(r'\d\d[0-1]\d[0-3]\d')) {
