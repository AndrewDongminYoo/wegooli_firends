...
import '/data/model/upload_image_request.dart';
...
class CarControllerApi {
  ...
  Future<Response<String>> uploadImage({
    required UploadImageRequest uploadImageRequest,
    required String carNum,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = '/car/upload/{carNum}'.replaceAll('{' 'carNum' '}', carNum);
    final _options = Options(
      method: 'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = jsonEncode(uploadImageRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
